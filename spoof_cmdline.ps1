...
Add-Type -TypeDefinition $SwampThing -Language CSharp

$desktop =  [Environment]::GetFolderPath("Desktop")
New-Item -Path "$desktop\executed_cmdline.txt" -ItemType File -Force
New-Item -Path "$desktop\spoofed_cmdline.txt" -ItemType File -Force

[Program]::SpawnTheThing('c:\\windows\\system32\\notepad.exe', "$desktop\executed_cmdline.txt", "$desktop\spoofed_cmdline.txt")
